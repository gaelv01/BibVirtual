...
Partial Class frmInicio
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(frmInicio))
        lblMarca = New Label()
        ...
        ' btnModoOscuro
        ' 
        btnModoOscuro.Location = New Point(15, 323)
        btnModoOscuro.Name = "btnModoOscuro"
        btnModoOscuro.Size = New Size(106, 23)
        btnModoOscuro.TabIndex = 11
